...
__DEFINE__(1644810648331, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644810648332,"./event-store":1644810648333}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644810648332, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644810648333, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644810648332,"./utils":1644810648334}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644810648334, function(require, module, exports) {
...
return __REQUIRE__(1644810648331);
})()
